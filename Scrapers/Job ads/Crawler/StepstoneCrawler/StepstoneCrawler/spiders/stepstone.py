...
class StepstoneSpider(scrapy.Spider):
    ...
    def parse(self,response):
        ...
        for job in result:
            ...
            try:    
                ...
                job_url =  job.css('div.JobItemFirstLineWrapper-sc-11l5pt9-2 a::attr(href)').extract_first()
                ...
                'Error'
            yield response.follow(next_url,callback=self.parse_job,meta={'job_item':job_id_item})
    ...
    def parse_job(self,response):
        ...
        loader.add_xpath('Description','normalize-space(.//div[@class="js-app-ld-ContentBlock"])')
